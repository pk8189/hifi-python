...
from v1_production.types.user.create import params, models
import typing
...
class CreateClient:
    ...
    def create(
        self,
        *,
        data: typing.Optional[params.PostUserCreateBody] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostUserCreateResponse:
        """
        ...
        _json = to_encodable(item=data, dump_with=params._SerializerPostUserCreateBody)
        ...
        return self._base_client.request(
            ...
            auth_names=["sec0"],
            json=_json,
            cast_to=models.PostUserCreateResponse,
