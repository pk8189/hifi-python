...
class GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsDestinationUser(
    pydantic.BaseModel
):
...
class GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsSourceAccount(
    pydantic.BaseModel
):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
...
class GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsSourceUser(
    pydantic.BaseModel
):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
...
class GetTransferFiatToCryptoAllResponseRecordsItemTransferDetails(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    destination_user: typing.Optional[
        GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsDestinationUser
    ...
    source_account: typing.Optional[
        GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsSourceAccount
    ...
    source_user: typing.Optional[
        GetTransferFiatToCryptoAllResponseRecordsItemTransferDetailsSourceUser
...
class GetTransferFiatToCryptoAllResponseRecordsItem(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    transfer_details: typing.Optional[
        GetTransferFiatToCryptoAllResponseRecordsItemTransferDetails
...
class GetTransferFiatToCryptoAllResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    records: typing.Optional[
        typing.List[GetTransferFiatToCryptoAllResponseRecordsItem]
