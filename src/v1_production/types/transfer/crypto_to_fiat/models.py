...
class GetTransferCryptoToFiatResponseTransferDetailsDestinationAccount(
    pydantic.BaseModel
):
...
class GetTransferCryptoToFiatResponseTransferDetailsDestinationUser(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetTransferCryptoToFiatResponseTransferDetailsSourceUser(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostTransferCryptoToFiatResponseTransferDetails(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetTransferCryptoToFiatResponseTransferDetails(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    destination_account: typing.Optional[
        GetTransferCryptoToFiatResponseTransferDetailsDestinationAccount
    ...
    destination_user: typing.Optional[
        GetTransferCryptoToFiatResponseTransferDetailsDestinationUser
    ...
    id: typing.Optional[str] = pydantic.Field(alias="id", default=None)
    liquidation_address: typing.Optional[str] = pydantic.Field(
        alias="liquidationAddress", default=None
    )
    request_id: typing.Optional[str] = pydantic.Field(alias="requestId", default=None)
    source_currency: typing.Optional[str] = pydantic.Field(
        alias="sourceCurrency", default=None
    ...
    source_user: typing.Optional[
        GetTransferCryptoToFiatResponseTransferDetailsSourceUser
...
class PostTransferCryptoToFiatResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    transfer_details: typing.Optional[
        PostTransferCryptoToFiatResponseTransferDetails
...
class GetTransferCryptoToFiatResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    transfer_details: typing.Optional[
        GetTransferCryptoToFiatResponseTransferDetails
    ] = pydantic.Field(alias="transferDetails", default=None)
    transfer_type: typing.Optional[str] = pydantic.Field(
        alias="transferType", default=None
    )
